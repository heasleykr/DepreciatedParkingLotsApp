    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image1', models.ImageField(upload_to='listing_images/1/%Y/%m/%d/')),
                ('image2', models.ImageField(upload_to='listing_images/2/%Y/%m/%d/')),
                ('image3', models.ImageField(upload_to='listing_images/3/%Y/%m/%d/')),
                ('image4', models.ImageField(upload_to='listing_images/4/%Y/%m/%d/')),
            ],
        ),
        migrations.CreateModel(
            name='Listing',
